...
<body>
	...
	쿠키
		: 클라이언트의 상태 정보를 유지하기 위한 기술로 클라이언트의 PC에 
		  파일형태로 저장된다. 쿠키 하나의 크기는 4kb이고, 3000개까지 
		  만들 수 있다. 
	 -->
	...
	*/
	...
	// 쿠키의 경로 설정. 컨택스트루트 경로로 지정하므로 웹어플리케이션 전체에서 
	// 사용할 수 있다.
	cookie.setPath(request.getContextPath());
	//System.out.println("설정 경로 : "+ request.get)
	...
	<%
	/*
	request내장 객체의 getCookies()를 통해 현재 생성된 모든 쿠키를 배열의 
	형태로 가져온다.
	*/
	...
	/*
	쿠키가 생성된 직후에는 쿠키값을 읽을 수 없다. 새로고침 하거나 페이지 이동을 
	통해 새로운 요청을 보내야만 읽을 수 있다.
	*/
	%>
